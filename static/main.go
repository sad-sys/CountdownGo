//Now need to add a frontend, very basic you press a button and it triggers the generate function and then
...
func main() {
	...
	//Prints out all the options to get to the final answer
